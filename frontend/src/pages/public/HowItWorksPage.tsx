...
export default function HowItWorksPage() {
  ...
  return (
    <div style={{ background: '#080808', minHeight: '100vh' }}>
      <Navbar />
      <div className="hiw-page" style={{ paddingTop: '110px' }}>
        <section className="hiw-hero" style={{ textAlign: 'center', padding: '80px 32px 60px', maxWidth: '800px', margin: '0 auto' }}>
        ...
        <section className="hiw-timeline-wrap" style={{ maxWidth: '900px', margin: '0 auto', padding: '0 32px 80px' }}>
          <div style={{ position: 'relative' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '32px' }}>
              {steps.map((s, i) => (
                <div key={s.n} className="hiw-step-row" style={{ display: 'flex', gap: '32px', alignItems: 'flex-start' }}>
                  <div className="hiw-step-icon-col" style={{ flexShrink: 0, width: '80px', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '8px' }}>
                    <div
                  ...
                  <div className="gold-card hiw-step-card" style={{ flex: 1, padding: '24px', borderRadius: '4px' }}>
        ...
        <section className="hiw-cta" style={{ textAlign: 'center', padding: '60px 32px 80px', borderTop: '1px solid rgba(201,168,76,0.08)' }}>
