export default {
  ...
  legal: { legal: 'YASAL', lastUpdated: 'Son güncelleme: 2026 · Sürüm 4.0', termsTitle: 'HİZMET ŞARTLARI VE KOŞULLARI', termsIntro: 'LLC „Merge Varskvlavebi" (ID 406286424). Kayıt veya sipariş öncesinde bu Şartları tamamen okuyun. Kabul etmiyorsanız Platformu derhal kullanmayı bırakın.', privacyTitle: 'GİZLİLİK POLİTİKASI', referralPolicyTitle: 'REFERANS POLİTİKASI', privacyLink: 'Gizlilik', referralLink: 'Referans' },
  common: { download: 'İNDİR', share: 'PAYLAŞ', copy: 'KOPYALA', send: 'GÖNDER', save: 'Kaydet', cancel: 'İptal', loading: 'Yükleniyor…' },
  ai: {
    kicker: 'AI ASİSTAN',
    title: 'Merge AI',
    suggestedLabel: 'Önerilen sorular',
    placeholder: 'MERGE STARS hakkında sorun...',
    welcome: 'Merhaba! MERGE STARS AI asistanıyım.\n\n⚠ Finansal tavsiye veremem.',
    ...
    coreTraining:
      ...
      'LANGUAGE FILTER\n' +
      'Kullanma: Guaranteed, Approved, Risk Free, Impossible To Fail\n' +
      'Kullan: Evidence-Based, Review Ready, Verification Required, Risk Controls, Measured, Auditable\n\n' +
      'FINAL LINE\n' +
