...
export default {
  ...
  aiPage: {
    ...
    responses: {
      ...
      mergeCoin: 'MERGE COIN, MERGE STARS platformundaki Ürün Referans Biriminiz ve Marka Kimliğinizdir. Gerçek gümüş, altın veya platin içeren değerli metal kompozitli (3D filament) fiziksel bir lüks üründür. Kripto para, token veya finansal enstrüman DEĞİLDİR. Her coin benzersiz bir QR kodu ve Dijital Pasaporta sahiptir.',
