export default {
  termsSections: [
    ...
    },
    {
      ...
      items: [
        ...
        'Production and delivery process coordination',
        'Catalog development through House Treasury',
        'Phased development of digital and physical infrastructure',
      ],
    },
    {
      title: 'Acceptance',
    ...
    {
      title: 'Warning',
      body: 'If you do not fully or partially agree to these Terms, you must immediately stop using the Platform.',
    },
    {
      title: '1.1. Personal Data Processing Consent',
    ...
    {
      title: '5. KYC and Identity Verification',
      items: [
        'KYC verification is mandatory for full use of Platform functionality.',
        'You agree to provide identity documents.',
        'The Company reserves the right to request re-verification at any time.',
        'Failure to pass KYC may result in restricted access, order suspension, or account closure.',
      ],
    },
    {
    ...
    {
      title: '9. Referral Program and Prohibitions',
      items: [
    ...
    },
    {
      ...
      items: [
        ...
        'System damage to the Platform (scraping, reverse engineering).',
        'Cloning, manipulating, or misusing QR codes to falsify identity or referrals.',
        'Presenting LLC „Merge Varskvlavebi" as an investment or crypto project.',
      ],
    },
    {
  ...
  trustPage: {
    ...
    title: 'TRUST',
    titleGold: 'CENTER',
    subtitle: 'Security, compliance, and transparency at the core of MERGE STARS.',
  },
  referralPolicyPage: {
    kicker: 'LEGAL',
    title: 'REFERRAL',
  ...
  mergeCoinPage: {
    kicker: 'MERGE COIN',
    heroBadge: '★ LIVING BRAND ACTIVATION SYSTEM ★',
    heroTitle: 'MERGE COIN',
    heroGold: 'BRAND IDENTITY',
    heroBody: 'MERGE COIN is your Product Reference Unit — a physical luxury product with QR-linked digital passport. Not a cryptocurrency or financial instrument.',
