export default {
  faq: {
    ...
    items: [
      ...
      { q: 'How long does production take?', a: 'Production timelines vary by order type and factory availability. Once payment is confirmed, your order enters the production queue. You will receive real-time status updates throughout.' },
      { q: 'What payment methods are accepted?', a: 'We accept Full Payment (bank transfer, card) and payment from your Earnings Wallet. Crypto is not supported.' },
  ...
  howItWorks: {
    ...
    steps: [
      ...
      { n: '06', title: 'PAYMENT', desc: 'Choose Full Payment or Earnings Wallet. Production begins only after payment is confirmed.' },
