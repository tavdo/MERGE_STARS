export default {
  admin: {
    ...
    nav: { dashboard: 'პანელი', bankReview: 'ბანკის განხილვა', auditCenter: 'აუდიტი', compliance: 'კომპლაიენსი', security: 'უსაფრთხოება', dataGov: 'მონაცემები', continuity: 'უწყვეტობა', users: 'მომხმარებლები', kyc: 'KYC', applications: 'განაცხადები', finance: 'ფინანსები', crystal: 'CRYSTAL', production: 'წარმოება', analytics: 'ანალიტიკა', auditLog: 'აუდიტ ლოგი', settings: 'პარამეტრები', groupOperations: 'ოპერაციები', groupCompliance: 'კომპლაიენსი', groupSystem: 'სისტემა' },
